...
export default function AccommodationAssistant({ dict, lang }: AccommodationAssistantProps) {
  const options = [
    ...
    { key: "shared", icon: Users, color: "bg-purple-500" },
            ...
            return (
              <Link key={option.key} href={`/${lang}/contact`} className="block">
                <motion.div
                  ...
                  className="group relative bg-gray-50 rounded-2xl p-8 border border-gray-100 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden h-full cursor-pointer"
                >
                  {}
