...
export default function SchoolForm({ onBack, dict }: SchoolFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('School Application:', formData);
    alert('School application submitted! (Demo)');
  };
    ...
    <div className="max-w-3xl mx-auto bg-white rounded-3xl p-8 md:p-12 shadow-2xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <label className="block text-sm font-bold text-gray-900 mb-2 uppercase">{dict.fields.studentName} *</label>
          ...
          <div>
            <label className="block text-sm font-bold text-gray-900 mb-2 uppercase">{dict.fields.parentName} *</label>
