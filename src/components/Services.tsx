        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 auto-rows-[minmax(240px,auto)]">
          {services.map((service) => (
            <div 
              key={service.key}
              className={cn(
                "group relative overflow-hidden rounded-[2rem] transition-all duration-300 hover:shadow-xl border border-gray-100",
                service.className
              )}
            >
              ...
              <div className={cn(
                ...
                {/* Quarter Circle Decoration for Flight Ticket and Accommodation */}
