...
export interface ApiCityCity extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Cities where students can study';
    displayName: 'City';
    pluralName: 'cities';
    singularName: 'city';
  };
  ...
  attributes: {
    climateContent: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    climateTable: Schema.Attribute.JSON &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    economyContent: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    housingContent: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    transportContent: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCountryCountry extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Countries where students can study';
    displayName: 'Country';
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'User-submitted reviews pending moderation';
    displayName: 'Review';
    pluralName: 'reviews';
    singularName: 'review';
  };
  ...
  attributes: {
    ...
    service: Schema.Attribute.Enumeration<
      ['university', 'school', 'transfer', 'visa', 'umrah', 'ticket', 'other']
    > &
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Video testimonials from students';
